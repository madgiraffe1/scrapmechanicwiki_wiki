        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <ul>
              ...
              <li><strong>Build useful tools:</strong> Develop guides, value calculators, and planners that help players make informed decisions</li>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Axes and Upgrades</h3>
              <p className="text-slate-300">
                Comprehensive axe tier lists and upgrade guides to help you choose the best gear.
                Master the progression from stone to mythic axes!
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">🌍</div>
              <h3 className="text-xl font-semibold text-white mb-2">Worlds and Areas</h3>
              <p className="text-slate-300">
                Detailed guides on all worlds and areas, their unique features, and resources.
                Explore every corner of the farm map efficiently.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">🦋</div>
              <h3 className="text-xl font-semibold text-white mb-2">Items and Axes Database</h3>
              <p className="text-slate-300">
                Complete information on all axes, items, and wood types, their values, and upgrade paths.
                Optimize every cut for maximum profit.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Up-to-date lists of all working codes and their rewards.
                Claim every free boost, slot, and rebirth currency.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              <div className="text-2xl mb-3">📚</div>
              <h3 className="text-xl font-semibold text-white mb-2">Idle Farming Strategies</h3>
              <p className="text-slate-300">
                Essential idle farming tips, building strategies, and progression guides.
                Learn how to grow your wood empire efficiently.
              </p>
            </div>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              <strong>Want to contribute?</strong> Whether you've discovered a new code, found a hidden axe,
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-slate-400 italic text-sm">
              Project Codename: "Timberline" – Growing the wood empire together.
            </p>
          </div>
        </div>
      </section>
