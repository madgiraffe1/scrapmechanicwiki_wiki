...
export async function getLatestArticles(
  ...
  // Keep ordering deterministic across static HTML and client hydration.
  ...
  // 排序：更新时间降序，同时间按分类和 slug 稳定排序
  articlesWithMeta.sort((a, b) => {
    if (a.updateTime !== b.updateTime) return b.updateTime - a.updateTime
    const typeCompare = a.article.contentType.localeCompare(b.article.contentType)
